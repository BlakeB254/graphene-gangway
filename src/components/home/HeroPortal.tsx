        ...
        >
          <div>
            ...
            <div className="overflow-hidden">
              <h1 className="font-[family-name:var(--font-display)] text-4xl leading-[0.9] tracking-wider text-ice-white sm:text-5xl md:text-6xl lg:text-7xl">
                BUILD YOUR
              </h1>
            </div>
            <div className="overflow-hidden">
              <h1 className="font-[family-name:var(--font-display)] text-4xl leading-[0.9] tracking-wider text-cyan-neon text-glow-cyan sm:text-5xl md:text-6xl lg:text-7xl">
                BUSINESS.
              </h1>
            </div>
            <div className="mt-2 overflow-hidden">
              <p className="font-[family-name:var(--font-display)] text-2xl leading-[0.9] tracking-wider text-ice-white/60 sm:text-3xl md:text-4xl lg:text-5xl">
                We&apos;ll Build Everything Else.
              </p>
            </div>

            <p className="mt-6 max-w-md font-[family-name:var(--font-body)] text-base text-ice-white/40 md:text-lg">
              Brand kits, websites, automations, AI tools &mdash; your full digital
              ecosystem, built and managed so you can focus on what matters.
            </p>

            {/* Trust indicators */}
            <div className="mt-6 flex items-center gap-6">
              <div className="flex items-center gap-2">
                <span className="font-[family-name:var(--font-display)] text-2xl text-cyan-neon">87+</span>
                <span className="font-[family-name:var(--font-mono)] text-[10px] uppercase tracking-wider text-ice-white/30">Brands Built</span>
              </div>
              <div className="h-4 w-px bg-ice-white/10" />
              <div className="flex items-center gap-1">
                {[...Array(5)].map((_, i) => (
                  <svg key={i} className="h-3.5 w-3.5 fill-cyan-neon" viewBox="0 0 20 20">
                    <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                  </svg>
                ))}
                <span className="ml-1 font-[family-name:var(--font-mono)] text-[10px] text-ice-white/30">5.0</span>
              </div>
            </div>
            ...
            <div className="mt-6 inline-flex items-center gap-2 rounded-full border border-cyan-neon/20 bg-cyan-neon/5 px-4 py-2">
              <div className="h-2 w-2 rounded-full bg-cyan-neon animate-pulse" />
              <span className="font-[family-name:var(--font-mono)] text-[10px] uppercase tracking-wider text-cyan-neon/80">
                Performance Guarantee &mdash; Up to $12,000 in coverage
              </span>
            </div>
          </div>
        </motion.div>
